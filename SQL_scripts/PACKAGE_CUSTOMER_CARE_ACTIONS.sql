create or replace PACKAGE CUSTOMER_CARE_ACTIONS
AS

    PROCEDURE CLOSED_BY_CUSTOMERCARE(T_ID IN TICKETING_QUEUE.TICKET_ID%TYPE);

END CUSTOMER_CARE_ACTIONS;

create or replace PACKAGE BODY CUSTOMER_CARE_ACTIONS AS
